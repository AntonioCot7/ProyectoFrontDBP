...
import { getMedicoInfo, updateMedicoInfo, deleteMedico } from '../services/api';
            ...
            <div className="w-1/2 bg-gray-300 p-6 rounded-xl shadow-md">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-customBlue text-white py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500 hover:bg-green-700 transition duration-200"
                >
                  Actualizar
                </button>
              </div>
            ...
            <div className="w-1/2 flex flex-col items-center">
              <div className="p-8 bg-gray-300 rounded-lg shadow-lg w-3/4">
                ...
                <div className="flex items-center">
                  <img src={UserIcon} alt="Medico" className="h-32 w-32 mr-4" />
